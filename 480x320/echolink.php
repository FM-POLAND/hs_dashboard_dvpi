...
if (isset($_POST['button9']))
 ...
 if (isset($_POST['button13']))
    {
        shell_exec('echo "2# 987526#" > /tmp/dtmf_svx');
    }
 if (isset($_POST['button14']))
    {
        shell_exec('echo "2# 735267#" > /tmp/dtmf_svx');
    }
...
<!--        <h1><center><p style="color: #454545;font-size:20px">Others</center></h1></p>-->
        ...
        <button class="orange" style="height: 60px; width: 130px;font-size:16px;" button name="button11">ECHOLINK</button>
        <button class="orange" style="height: 60px; width: 130px;font-size:16px;" button name="button12">METAR</button></br>
        <button class="purple" style="height: 60px; width: 130px;font-size:16px;" button name="button13">M0IQF-L</button>
        <button class="purple" style="height: 60px; width: 130px;font-size:16px;" button name="button14">HF9ZHP-L</button>
        <button class="purple" style="height: 60px; width: 130px;font-size:16px;" button name="button15">EL-</button></br>
        <button class="red" style="height: 60px; width: 130px;font-size:16px;" button name="button31">Disconnect</button>
    </center>
    </p>
    </form>
<!--
