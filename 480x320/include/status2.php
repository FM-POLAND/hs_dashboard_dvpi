...
?>
<div style="width:440px;"><span style="font-weight: bold;font-size:18px;"></span></div>
<!--<fieldset style="width:440px;background-color:#000000;margin-top:0px;;margin-bottom:0px;margin-left:0px;margin-right:0px;font-size:14px;">-->
<?php
...
echo "<table colspan=2 style=\"margin-top:0px;margin-bottom:3px;\">\n";
...
echo "</table>";
echo "<table  style=\"margin-bottom:3px;\"><tr><th>Radio Status</th></tr><tr>";
echo getTXInfo();
echo "</table>\n";

echo "<table  style=\"margin-bottom:3px;\"><tr><th>SVXReflector</th></tr><tr>";
