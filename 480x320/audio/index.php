...
echo '<p style="margin-bottom:10px;margin-top:10px;"><span style="font-size:14px;color:#464646;font-weight:bold">'.$filelist[0].'</span></p>';
...
<p style="margin-bottom:0px;"></p>
    ...
    <form method="post">
    <p>
    <input name="recAudio" type="submit" class="red" onclick="func()" id="runRec" type="button" value="Kliknij aby nagrać testowe audio 10 sec" style="height:45px;font-size:18px;"></input>
    </p>
    </form>
